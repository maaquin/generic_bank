...
export const deleteFav = async (req, res) => {
    try {
        const { id } = req.params;
        console.log('id: ', id); // Para depuración, asegúrate de que el id es correcto
        ...
        console.log('Eliminado: ', fav); // Para depuración, asegúrate de que el documento se elimina

        return res.status(200).json({ message: 'Favorito eliminado correctamente', fav });
    } catch (e) {
        console.log(e);
